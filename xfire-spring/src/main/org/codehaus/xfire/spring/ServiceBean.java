...
//        
    	...
    	logger.info("starting afterPropertiesSet");
        ...
        if (wsdlURL != null)
        {
        	logger.info("wsdlURL != null -> " + wsdlURL);
        ...
        {
        	logger.info("wsdlURL is null -> " + intf + " <- name -> " + name + " <- namespace -> " + namespace + " <- properties -> " + properties);
            xfireService = serviceFactory.create(intf, name, namespace, properties);
        }

        logger.info("before executor ");
        ...
        logger.info("will call initializeBindings ");
        ...
        logger.info("finishing afterPropertiesSet");
    }
